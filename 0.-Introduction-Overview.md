...
## 🏗️ The Architecture of Modern Minecraft Modification
...
### Era 2: The Forge Dominance (2012-2023) ⭐
- **Problem:** Multiple incompatible frameworks competing
- **Solution:** Minecraft Forge became dominant (90%+ market share)
- **Achievement:** Stable event buses, registry systems, massive ecosystem
- **Legacy:** Billions of lines of Forge code still in production

### Era 3: The Alternatives Emerge (2020-Present)
- **Problem:** Forge update speed concerns prompted experimentation
- **Solution:** Fabric offered lightweight alternative; NeoForge modernized Forge
- **Current State:** Forge remains dominant; alternatives serve specific niches
- **Ongoing:** Forge continues active development and improvement

### Era 4: The Data-Driven Shift (2023-Present)
...
- **Impact:** Works across Forge, Fabric, and NeoForge equally

---

## 🎯 What Makes 1.21 Different

Minecraft 1.21 represents the most aggressive technical overhaul since the Java Edition's inception. This isn't simply a balance patch or cosmetic update—it's an architectural revolution.
...
**Before 1.21:**
```java
// ❌ Creating a custom weapon required extending a specific class
...
**After 1.21:**
```java
// ✅ All items are plain Item objects with independent components
...
## 🌐 The Modern Mod Loader Landscape
...
- **Forge:** Largest ecosystem, mature APIs, great for beginners
- **Fabric:** Maximum performance and speed, minimal dependencies
- **NeoForge:** Modern Java paradigms, fast updates, small ecosystem

**For new projects, Forge is universally recommended unless you have specific requirements.**
...
```
┌─────────────────────────────────────────────┐
│         Your Mod Source Code (.java)        │
├─────────────────────────────────────────────┤
│           IDE: IntelliJ IDEA                │
│    (editor, compiler, debugger, decompiler)|
├─────────────────────────────────────────────┤
│     Build System: Gradle + Loader Plugin    │
│   (compiles, decompiles, remaps, packages) │
├─────────────────────────────────────────────┤
│ Runtime: Mod Loader (Forge / Fabric / NeoForge)     │
│  (injects mod into game, provides APIs)     │
├─────────────────────────────────────────────┤
│     Runtime: Minecraft Server/Client        │
│           (the actual game)                 │
└─────────────────────────────────────────────┘
```
...
| Term | Meaning |
|---|---|
| **MDK** | Mod Development Kit — a template project downloaded from a loader's website |
...
1. [1. Environment Setup](1.-Environment-Setup) — Install Java and set up IntelliJ
2. [2. Mod Loaders](2.-Mod-Loaders) — Use Forge (recommended)
3. [8. Example Mod Setup](8.-Example-Mod-Setup) — Create your first project
...
2. Read [2. Mod Loaders](2.-Mod-Loaders) to understand why Forge is recommended
...
**Goal:** Migrate a working Forge 1.20.x mod to 1.21+

1. Review [4. Porting to 1.21](4.-Porting-to-1.21) for structural changes
2. Study [5. Data Component System](5.-Data-Component-System) — this will require major rewrites
...
Ready to get started? [Proceed to Environment Setup →](1.-Environment-Setup)
